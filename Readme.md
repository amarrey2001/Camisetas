...
/admin/usuario | GET | Muestra todos los usuarios | OPERARIO
/admin/usuario/\[id\] | GET | Muestra el usuario con ese ID | OPERARIO
/admin/usuario/del/\[id\] | GET | Muestra el formulario que pregunta si borrar el usuario con ese ID | OPERARIO
/admin/usuario/del/\[id\] | POST | Borra realmente el ususario con ese ID | OPERARIO
/admin/usuario/add | GET | Muestra el formulario para añadir una camiseta | OPERARIO
/admin/usuario/add | POST | Añade el ususario a la BBDD | OPERARIO
/admin/usuario/update/\[id\] | GET | Muestra el formulario con los datos de el ususario a actualizar | OPERARIO
/admin/usuario/update/\[id\] | POST  | Actualiza realmente el ususario con ese ID | OPERARIO
